...
{:else}
  <div class="divide-y">
    {#each venues as venue}
      ...
      <div class="py-4">
        <a sveltekit:prefetch href="/{venue.slug}">
          <div class="text-gray-900 space-y-3">
            <h1 class="font-semibold text-lg">{venue.name}</h1>
            <p class="truncate text-gray-600">{venue.description}</p>
            <address class="not-italic text-gray-600 w-full">
